...
#         resp = self.user_client.post("/brand/1/products", data=[101], content_type="application/json")
#         self.assertEquals(404, resp.status_code)
...
#         self.assertDictEqual(data["objects"][0], {"id": 1, "barcode": "product_1", "brand_id": 1})
#         self.assertEquals(1, Product.objects.get(id=101).brand_id)


#     def test_post_correct_parent_and_reverse_perms_with_correct_read_perms_v2(self):
#         p.set_perms_shortcut(self.user, Brand.objects.get(id=1), "wr", field_name="products")
...
#         p.set_perms_shortcut(self.user, Product.objects.filter(id=101), "w", field_name="brand")
#         resp = self.user_client.post("/brand/1/products", data=[101], content_type="application/json")
#         data = resp.json()
#         self.assertEquals(3, len(data["objects"]))
#         self.assertDictEqual(data["objects"][0], {"id": 9, "barcode": "product_9", "brand_id": 1})
...
#         resp = self.user_client.delete("/brand/1/products", data=[99], content_type="application/json")
#         self.assertEquals(404, resp.status_code)
...
#         p.set_perms_shortcut(self.user, Product.objects.filter(id=9), "r")
#         p.set_perms_shortcut(self.user, Product.objects.filter(id=11), "r")
#         p.set_perms_shortcut(self.user, Product.objects.filter(id=99), "w", field_name="brand")
#         resp = self.user_client.delete("/brand/1/products", data=[99], content_type="application/json")
#         data = resp.json()
#         self.assertEquals(3, len(data["objects"]))
#         self.assertDictEqual(data["objects"][0], {"id": 9, "barcode": "product_9", "brand_id": 1})
