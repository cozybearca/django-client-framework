...
# class TestRetrievePerms(TestCase):
#     def setUp(self):
...
#         p.set_perms_shortcut(self.user, Product.objects.get(id=1), "r", field_name="brand")
...
#         resp = self.user_client.patch("/product/1/brand", data=[2], content_type="application/json")
...
#         p.set_perms_shortcut(self.user, Product.objects.get(id=1), "rw", field_name="brand")
#         p.set_perms_shortcut(self.user, Brand.objects.get(id=1), "w", field_name="products")
#         p.set_perms_shortcut(self.user, Brand.objects.get(id=2), "r")
#         p.set_perms_shortcut(self.user, Brand.objects.get(id=2), "w", field_name="products")
#         resp = self.user_client.patch("/product/1/brand", data=[2], content_type="application/json")
#         self.assertEqual(2, Product.objects.get(id=1).brand_id)
#         self.assertDictEqual({'id': 2, 'name': 'br2'}, resp.json())